...
int main() {
    ...
    // // Load image, create texture and generate mipmaps
    // int width1, height1;
    // unsigned char* image1 = SOIL_load_image("Bump-Map.jpg", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view_sphere = glm::translate(view_sphere, glm::vec3(-4.0f, 5.0f, -4.0f)); // Translate sphere back and to the left
