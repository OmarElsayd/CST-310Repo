...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Pass to shaders
        glUniform3f(cubeColorLoc, 1.0f, 0.0f, 1.0f); // Pass cube color to uniform
        ...
        glUniform3f(cylinderColorLoc, 0.0f, 1.0f, 1.0f); // Pass color to uniform
        glUniform3f(lightColorLoc, 1.0f, 1.0f, 1.0f); // Pass light color to uniform
        glUniform3f(lightPosLoc, lightPos.x, lightPos.y, lightPos.z); // Pass light position to uniform
        glUniform3f(viewPosLoc, camera.Position.x, camera.Position.y, camera.Position.z); // Pass camera position to uniform
        ...
        view_cylinder = glm::translate(view_cylinder, glm::vec3(-2.4f, -2.4f, -5.0f)); // Translate cylinder back, to the right, and down
        ...
        view_sphere = glm::translate(view_sphere, glm::vec3(2.2f, 0.35f, -4.9f)); // Translate sphere back and to the left
        view_sphere = glm::scale(view_sphere, glm::vec3(0.85f, 0.85f, 0.85f)); // Scale down sphere
